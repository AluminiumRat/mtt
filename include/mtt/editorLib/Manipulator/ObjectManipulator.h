...
namespace mtt
{
  ...
  public:
    ...
    inline static const glm::vec4 xActivatedColor =
                                                  glm::vec4(1.f, .1f, .1f, .8f);
    ...
    inline static const glm::vec4 yActivatedColor =
                                                  glm::vec4(.1f, 1.f, .1f, .8f);
    ...
    inline static const glm::vec4 zActivatedColor =
                                                  glm::vec4(.1f, .1f, 1.f, .8f);

  public:
    explicit ObjectManipulator(Object3D& object);
