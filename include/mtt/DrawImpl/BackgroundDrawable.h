...
namespace mtt
{
  ...
  private:
    ...
    {
    public:
      DrawTechnique(bool transparentRender, BackgroundDrawable& parent);
  ...
  private:
    ...
    struct TechniquesSet
    {
      std::unique_ptr<DrawTechnique> opaqueTechnique;
      std::unique_ptr<DrawTechnique> peelingTechnique;
    };
    TechniquesSet _techniques;
  };
  ...
  inline void BackgroundDrawable::setDissolutionLength(float newValue) noexcept
  {
